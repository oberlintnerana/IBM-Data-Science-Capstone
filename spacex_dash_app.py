...
# Default Pie Chart
fig_default = px.pie(spacex_df, values='class', names='Launch Site', title='Total Success Launches by Site')
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                html.Div(dcc.Graph(id='success-pie-chart', figure = fig_default)),
                                html.Br(),
...
def get_pie_chart(site_val):
    ...
    if site_val == 'ALL':
        ...
        filter_df = spacex_df[spacex_df['Launch Site']==site_val]
...
def get_scatter(site_dropdown,slider_range):
    ...
    scatter_fig = px.scatter(filtered_df, x = 'Payload Mass (kg)', y = 'class', 
                            color="Booster Version Category", names='Launch Site', 
